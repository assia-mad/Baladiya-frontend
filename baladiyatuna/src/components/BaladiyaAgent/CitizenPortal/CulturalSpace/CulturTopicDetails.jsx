...
const CulturTopicDetails = ({ mode, handleChange, handleSwitchChange, handleCreate, handleUpdate, modifiedTopic, handleImageUpload }) => {
...
export default CulturTopicDetails;
